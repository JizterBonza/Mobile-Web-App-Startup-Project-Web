          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="text-center">
                ...
                <p className="text-muted">You are logged in as <strong>Admin</strong></p>
                <p className="text-muted">You can manage vendors, veterinarians, orders, and system operations.</p>
                {sessionValid && (
