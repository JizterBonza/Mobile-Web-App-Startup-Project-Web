...
export default function AddSuperAdmin({ auth }) {
    useDashboardSession()
    ...
    return (
        <SuperAdminKlasmeytLayout auth={auth} title="Add Super Admin" notificationCount={0}>
            <Head title="Add Super Administrator" />
                ...
                <div className="container mx-auto px-6 py-8">
                    <div className="mx-auto max-w-5xl">
                        <div className="mb-8 pt-10 sm:pt-4">
                            <h1 className="mb-2 text-2xl font-semibold text-[#102059]">Add Super Administrator</h1>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            style={{ boxShadow: 'none' }}
                                        />
                                        <p className="mt-1 text-xs text-[#6B7280]">This email will be used for super admin login</p>
                                    </div>
                                ...
                                <div className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex justify-between gap-4">
                                                    ...
                                                    <span className="text-sm font-semibold text-[#102059]">Super Admin</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="rounded-lg border border-[#244693]/20 bg-[#EEF2FF] p-4">
                                        <div className="flex gap-3">
                                            ...
                                            <div>
                                                <p className="mb-1 text-sm font-semibold text-[#102059]">Super admin account creation</p>
                                                <p className="text-xs leading-relaxed text-[#65676B]">
                                                    This user will have full platform access equal to yours. Share the password securely
                                                    and only with trusted operators. You can deactivate the account later from Accounts.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="relative w-full max-w-md rounded-lg bg-white p-8">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="mb-2 text-2xl font-bold text-[#102059]">Confirm super admin addition</h3>

                            <p className="mb-6 text-sm text-[#6B7280]">
                                Are you sure you want to create this super admin account? They will have full platform access. You can
                                deactivate the account later from Accounts.
                            </p>
